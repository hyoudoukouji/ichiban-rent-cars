        ...
        <main class="main-content">
            ...
            <div class="saved-grid">
                ...
                <div class="saved-card">
                    <a href="car_detail.php?id=<?php echo $car['id']; ?>" class="block relative">
                        <img src="<?php echo htmlspecialchars($car['image']); ?>" alt="<?php echo htmlspecialchars($car['name']); ?>" class="car-image rounded-t" />
                        <button class="remove-btn" onclick="event.preventDefault(); removeCar(this, <?php echo $car['id']; ?>)">
                            <i class="fas fa-times"></i>
                        </button>
                    </a>
                    <div class="car-info">
                        <h3><a href="car_detail.php?id=<?php echo $car['id']; ?>" class="hover:underline"><?php echo htmlspecialchars($car['name']); ?></a></h3>
                        <div class="rating">
